...
@Component({
  selector: 'app-afiliado-añadir-formulario',
  templateUrl: './afiliado-añadir-formulario.component.html',
  styleUrls: ['./afiliado-añadir-formulario.component.scss']
})
export class AfiliadoAñadirFormularioComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<AfiliadoAñadirFormularioComponent>,
